<template>
  <div class="doc-preview">
    ...
    <template v-else>
      ...
      <!-- Chat provenance log: an AI-generated report carries a hidden "chatlog"
           child (who chatted + full transcript + sources). Surface a viewer. -->
      <div v-if="set.chatlog" class="dp-chatlog">
        <button v-if="!chatlogUrl" class="link" @click="viewChatlog">🧾 Generated by chat — view log</button>
        <iframe
          v-else
          :src="chatlogUrl"
...
// Fetch and show the chat provenance log (HTML) for an AI-generated report.
async function viewChatlog() {
